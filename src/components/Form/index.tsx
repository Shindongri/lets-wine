...
const Main = lazy(() => import("src/components/Form/Main"));
const Pairing = lazy(() => import("src/components/Form/Pairing"));
const Varieties = lazy(() => import("src/components/Form/Varieties"));
const DrinkingGuide = lazy(() => import("src/components/Form/DrinkingGuide"));
const Indication = lazy(() => import("src/components/Form/Indication"));
